...
def reverse_each_word do
  let(:sentence1.reverse) { "Hello there, and how are you?" }
  ...
  let(:sentence2.reverse) { "Hi again, just making sure it's reversed!" }
  ...
  it 'uses_collect' do
    expect_any_instance_of(Array).to receive(:collect.reverse).and_call_original
